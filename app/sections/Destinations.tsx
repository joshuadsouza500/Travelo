...
const Destinations = () => {
  return (
    <Bounded className="h-auto  py-12 md:py-16  xl:space-y-4">
      ...
      <section className="flex  flex-col  gap-3 lg:gap-5 mx-2 lg:mx-10 2xl:mx-20 pt-10 lg:pt-12 cursor-pointer">
        <div className="flex max-sm:flex-col  w-full  max-sm:h-[75vh] max-md:h-[55vh] md:min-h-64 xl:min-h-80 gap-3 lg:gap-5 ">
          <div className="bg-[url('/destination/Bromo.jpeg')] bg-no-repeat bg- bg-cover group rounded-xl shadow-lg basis-full sm:basis-[60%] relative ">
            {" "}
            <div className="absolute inset-0 bg-gradient-to-t from-black/20 via-black/10 to-transparent  rounded-xl" />
            <div className="absolute bottom-2 md:bottom-4 left-2 md:left-4 z-10 w-full">
              ...
              <div className="w-full   flex justify-between items-center ">
                ...
                <ArrowRightFromLine className="transition-opacity opacity-0 duration-300 ease-in-out text-white/80 size-5 md:size-7 -translate-x-6  md:-translate-x-10 group-hover:opacity-100" />
              </div>
            </div>
          </div>
          <div className="bg-[url('/destination/Hill.jpeg')] bg-no-repeat bg-center bg-cover group rounded-xl shadow-lg basis-full sm:basis-[40%] relative">
            {" "}
      ...
      <div className=" flex justify-center py-6 xl:py-10">
        <Button color="black">View All Destinations</Button>
      </div>
    </Bounded>
  );
};
