        ...
        {destinations.map((destination, index) => (
          ...
          >
            ...
            <Image
              ...
              height={400}
              width={400}
              className=" object-center object-cover  h-full w-full group-hover:scale-105 transition-transform duration-300 aspect-[3/4] max-h-[300px] md:max-h-[350px] lg:max-h-[450px]  "
            />
