...
export function TravelSearch() {
  ...
  return (
    <div className="flex flex-col md:flex-row md:items-center md:divide-x rounded-xl border   shadow-sm w-full bg-white  font-DM_sans">
      ...
      {/* Destination Select */}
      <div className="pt-3 py-2 px-3 md:px-4 md:py-4 2xl:py-6   flex-1 ">
        <Select>
      ...
      {/* Date Picker */}
      <div className="py-2 px-3 md:px-4 md:py-4 2xl:py-6 flex-1 ">
        <Popover>
      ...
      <div className="p-4 md:bg-Orange   text-white rounded-r-xl md:hover:bg-orange-700 group ">
        <button className="w-[95%] mx-auto md:w-auto bg-Orange flex items-center justify-center group-hover:bg-orange-700  rounded-md    px-3 lg:px-6 py-2 2xl:py-4 font-sans font-medium h z-10 relative  ">
