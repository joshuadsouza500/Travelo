...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Content
    ref={ref}
    className=" overflow-hidden border-l-4 border-text-black   pt-2 ml-1 md:ml-2 pl-4 lg:pl-10 text-sm transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down  tracking-wide md:text-base text-text-black/75 max-md:mr-2"
    {...props}
  >
